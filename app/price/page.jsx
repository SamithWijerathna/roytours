...
export default function Gallery() {
  ...
  <h1 className="mb-2 text-2xl sm:text-4xl font-extrabold
                 bg-gradient-to-r from-green-700 via-green-500 to-white
...
<section className="p-4 flex flex-col md:flex-row items-center gap-8 max-w-7xl mx-auto">
  <div className="md:w-1/2 text-center md:text-left">
    ...
    <p className="mt-4 text-gray-700">
      ...
      Nuwara Eliya offers peaceful escapes, scenic views, and a refreshing break in the heart of the hills.</p>
  ...
  <div className="md:w-1/2 md:-translate-x-5">
    <TiltedCard
      ...
      showMobileWarning={true}
      showTooltip={false}
      overlayContent={ <div className="absolute" style={{ top: '60px', left: '280px',minWidth: '400px'  }}>
          <h3 className="text-6xl font-bold text-white">Nuwara
            <br/>
            Eliya</h3>
        </div>}
      displayOverlayContent={true}
...
<section className="p-4 flex flex-col md:flex-row items-center gap-8 max-w-7xl mx-auto">
  <div className="md:w-1/2 md:-translate-x-10">
    <TiltedCard
      ...
      showMobileWarning={true}
      showTooltip={false}
      overlayContent={<div className="absolute" style={{ top: '270px', left: '50px',minWidth: '400px'  }}>
...
<section className="p-4 flex flex-col md:flex-row items-center gap-8 max-w-7xl mx-auto">
  ...
  <div className="md:w-1/2">
    <TiltedCard
      ...
      showMobileWarning={true}
      showTooltip={false}
      overlayContent={   <div className="absolute" style={{ top: '50px', left: '30px',minWidth: '400px'  }}>
...
<section className="p-4 flex flex-col md:flex-row items-center gap-8 max-w-7xl mx-auto">
  <div className="md:w-1/2 md:-translate-x-10 ">
    <TiltedCard
      ...
      showMobileWarning={true}
      showTooltip={false}
      overlayContent={     <div className="absolute" style={{ top: '280px', left: '50px',minWidth: '400px'  }}>
