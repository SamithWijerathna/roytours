  ...
  return (
    <header className=" absolute top-0 left-0 w-full">
      <nav className="flex items-center justify-between p-4">
        <Image src="/image/logo.png" alt="Roytours Logo" width={204} height={790} />
        ...
        <button className="bg-transparent text-black border-2 border-black rounded-full px-4 py-2 flex items-center gap-2 font-semibold">Let’s travel <span>
