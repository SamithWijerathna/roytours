...
export default function footer(){
    return(
        <div>
        <footer className=" bg-[#1e1e1e] text-white hidden sm:block">
            <div className="flex flex-row justify-between w-full items-end px-[50px]">
                <h2 className="text-6xl font-semibold w-1/2">Let’s Plan Your Journey Together</h2>
                <p className="font-normal w-1/2 text-xl">Got a question or ready to book your adventure? We’d love to hear from you.</p>
            </div>
            <div className="flex justify-between items-center px-[50px]">
                <div className="w-1/2 py-20">
                    <Image src={'/image/logo-white.png'} width={270} height={70} alt="Roy Tours Logo"></Image>
                </div>
            ...
            <span className="flex items-center gap-2 py-2">
                Developed By
                <a href="https://www.cloudwave.asia"><img
